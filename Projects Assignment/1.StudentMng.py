...
# Create a menu based Python application for maintaining student information (roll no, name, marks).
# It contains basic functions which include:
#i. Add student information
#ii. display student information
#iii. search student using roll no
